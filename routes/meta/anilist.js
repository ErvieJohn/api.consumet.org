...
const routes = (fastify, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fastify.get("/staff/:id", (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            main_1.redis
                ? reply.status(200).send(yield cache_1.default.fetch(main_1.redis, `anilist:staff;${id}`, () => __awaiter(void 0, void 0, void 0, function* () { return yield anilist.fetchStaffById(Number(id)); }), 60 * 60))
...
const generateAnilistMeta = (provider = undefined) => {
    ...
    if (typeof provider !== 'undefined') {
        ...
        return new anilist_1.default(new gogoanime_1.default(), {
            url: process.env.PROXY,
        });
    }
};
